...
import { detectPlatformFromHeaders } from './utils';
...
// Test GitHub webhook
export async function testGitHubWebhook() {
...
export async function testTokenBasedWebhook() {
...
export function testPlatformDetection() {
  ...
  for (const testCase of testCases) {
    const request = createMockRequest(testCase.headers);
...
export async function testCustomSignature() {
