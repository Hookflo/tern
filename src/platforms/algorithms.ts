...
export function getPlatformAlgorithmConfig(platform: WebhookPlatform): PlatformAlgorithmConfig {
...
export function platformUsesAlgorithm(platform: WebhookPlatform, algorithm: string): boolean {
...
export function getPlatformsUsingAlgorithm(algorithm: string): WebhookPlatform[] {
